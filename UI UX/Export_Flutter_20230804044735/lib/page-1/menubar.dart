          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                height: 16.33*fem,
                child: Image.asset(
                  'assets/page-1/images/group-r25.png',
                  width: 31.33*fem,
                  height: 16.33*fem,
                ),
              ),
              Container(
                // autogroupz7p9w2y (NLtwpHUf2s8FuYvp1oZ7p9)
                width: double.infinity,
                height: 325*fem,
                child: Row(
